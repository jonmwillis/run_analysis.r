...
#6.1) Creates an intermediate dataset with all required measurements.
...
# 6.2) Creates the final, independent tidy data set with the average of each variable for each activity and each subject.
